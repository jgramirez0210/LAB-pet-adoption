...
// Form Submit Button 
  ...
  const createCard = (e) =>{
    ...
    const newCard ={
      ...
      name: document.querySelector("#animalColor").value,
      name: document.querySelector("#specialSkill").value,
      name: document.querySelector("#imageUrl").value,
    }
    console.log(newCard.name)
  }
  form.addEventListener('submit', createCard)form.addEventListener('submit', createCard)
